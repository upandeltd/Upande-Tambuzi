...
fixtures = [
    ...
    {
        "dt": "Client Script",
        "filters": [["name", "in", ["Qr Code gen" ,"Scan Via Honeywell", "Scan Data Field Listener", "Scan QR Button", "Populate Number of Items", "Grading Stock Entry", "Field Rejects Stock Entry"]]]
    },
    {
        "dt": "DocType",
