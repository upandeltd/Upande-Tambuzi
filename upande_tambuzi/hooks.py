...
override_whitelisted_methods = {
    ...
    "create_sales_invoice": "upande_tambuzi.server_scripts.create_sales_invoice.create_sales_invoice"
}
...
fixtures = [
    ...
    {
        "dt": "Client Script",
        "filters": [["name", "in", ["Qr Code gen", "Close Box Button" ,"Scan Via Honeywell", "Scan Data Field Listener", "Scan QR Button", "Populate Number of Items", "Grading Stock Entry", "Field Rejects Stock Entry"]]]
    },
    {
        "dt": "DocType",
