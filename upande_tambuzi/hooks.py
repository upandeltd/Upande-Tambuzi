...
doc_events = {
    ...
    # }
    # "Sales Order": {
    #     "on_submit": "upande_tambuzi.server_scripts.CPL_autogenerated_on_SO_submission.create_consolidated_pack_list"
    # }
}
...
fixtures = [{
    ...
    "filters": [[
        ...
        [
            ...
            "Grader QR Code", "Harvest", "Scanned Items", "Scan Check",
            "Scan Check List", "QR Sequence"
        ]
    ]]
}, {
    "dt": "Print Format",
